...
const Slider = () => {
  ...
  return (
     ...
     <div className="md:w-2/2 relative items-center justify-center h-96 md:h-screen w-full flex flex-col lg:flex-row">
  {/* Background Image */}
  <Image
  ...
  <div className="absolute inset-0 z-20 items-center flex flex-col">
    {/* Center Content */}
    ...
    {/* Bottom Info Bar */}
    <div className="hidden md:flex absolute bottom-5 left-1/2 -translate-x-1/2 w-[90%] opacity-60 bg-gray-300 backdrop-blur-2xl bg-opacity-50 z-20 text-gray-600 rounded-md justify-between p-5">
